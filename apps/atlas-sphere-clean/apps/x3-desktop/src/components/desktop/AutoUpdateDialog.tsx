            ...
            <div className="tab-content">
              <div className="details-grid">
                <div className="detail-item">
                  ...
                  <span className="value">v{updateInfo.current_version}</span>
                </div>
                <div className="detail-item">
                  <label>Latest Version</label>
                  <span className="value">v{updateInfo.latest_version}</span>
                </div>
                {latestVersion && (
                  <>
                    <div className="detail-item">
                      <label>Release Date</label>
                      <span className="value">{new Date(latestVersion.release_date).toLocaleDateString()}</span>
                    </div>
                    <div className="detail-item">
                      <label>Download Size</label>
                      <span className="value">{formatBytes(latestVersion.download_size)}</span>
                    </div>
                  </>
                )}
              </div>
