...
## Phase 4.5 — Liquidity, Inventory, and Solvency

- [x] Write spec: `docs/specs/X3_LIQUIDITY_INVENTORY_SOLVENCY_SPEC.md`
- [x] Write implementation plan: `docs/implementation/PHASE_4_5_LIQUIDITY_IMPLEMENTATION_PLAN.md`
- [x] Write execution tickets: `docs/implementation/PHASE_4_5_EXECUTION_TICKETS.md`
- [x] TICKET-4.5-001: Core type definitions
- [x] TICKET-4.5-002: Vault storage and band invariants
- [x] TICKET-4.5-003: Lane storage and freeze mechanics
- [x] TICKET-4.5-004: Inventory reserve and release
